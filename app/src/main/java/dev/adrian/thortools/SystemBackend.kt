...
class RealSystemBackend(private val context: Context) : SystemBackend {
    override fun snapshot(operation: OperationState): ThorSnapshot {
        ...
        return ThorSnapshot(
            ...
            backupAvailable = PatchUtils.checkActiveSlotBackupExists(
                context,
                properties.slot,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ),
            stockRestoreAvailable = PatchUtils.checkActiveSlotRestoreExists(
                context,
                properties.slot,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ),
            patchedBackupAvailable = PatchUtils.checkBootMagiskExists(
                context,
                properties.slot,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ...
            stockBackupSlots = PatchUtils.stockBackupSlots(
                context,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ),
            stockRecoverySlots = PatchUtils.stockRecoverySlots(
                context,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ),
            patchedBackupSlots = PatchUtils.patchedBackupSlots(
                context,
                availablePartitionsBySlot,
                properties.buildIdentity,
            ),
