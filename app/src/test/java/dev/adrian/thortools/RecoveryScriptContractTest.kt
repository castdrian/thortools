...
class RecoveryScriptContractTest {
    ...
    @Test
    fun patchScriptsFallbackToTheVerifiedDownloadStockCopy() {
        listOf(
            "boot.patch.sh" to "BOOT_IMG=\"\$DOWNLOAD_PATH/boot\$ACTIVE_SLOT.img\"",
            "init_boot.patch.sh" to "BOOT_IMG=\"\$DOWNLOAD_PATH/init_boot\$ACTIVE_SLOT.img\"",
