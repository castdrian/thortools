...
ThorTools recognizes AYN Thor Lite, Base, Pro, and Max variants. Lite uses the Snapdragon 865 (SM8250/Kona); Base, Pro, and Max use the Snapdragon 8 Gen 2 (SM8550/QCS8550/Kalama). The upper display is 1920 × 1080 at 120 Hz and the lower display is 1240 × 1080 at 60 Hz; Android may report the lower panel as its natural 1080 × 1240 orientation with a quarter-turn rotation. The upper panel is a read-only status dashboard; the lower panel owns navigation, actions, and confirmations.
...
- Lower-screen cancellation for non-partition operations with recovery journaling
